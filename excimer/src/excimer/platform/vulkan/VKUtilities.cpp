...
namespace Excimer
{
    namespace Graphics
    {
        uint32_t VKUtilities::FindMemoryType(uint32_t typeFilter, VkMemoryPropertyFlags properties)
        {
            ...
            EXCIMER_LOG_ERROR("Failed to find suitable memory type!");
            return 0;
        }
            ...
            VkDeviceMemory& bufferMemory, VmaAllocator allocator, VmaAllocation allocation)
        {
            ...
            {
                EXCIMER_LOG_ERROR("Failed to allocate buffer memory!");
            }
            ...
            VkFormatFeatureFlags features)
        {
            ...
            EXCIMER_LOG_ERROR("Failed to find supported format!");
...
#undef STR
        ...
        VkDescriptorType VKUtilities::DescriptorTypeToVK(DescriptorType type)
        {
            ...
            EXCIMER_LOG_INFO("Unsupported Descriptor Type");
            return VK_DESCRIPTOR_TYPE_UNIFORM_BUFFER;
        }
        ...
        RHIFormat VKUtilities::VKToFormat(VkFormat format)
        {
            ...
            default:
                EXCIMER_LOG_CRITICAL("[Texture] Unsupported texture type!");
                return RHIFormat::R8G8B8A8_Unorm;
            }
        }
        ...
        VkShaderStageFlagBits VKUtilities::ShaderTypeToVK(const ShaderType& shaderName)
        {
            ...
            default:
                EXCIMER_LOG_CRITICAL("Unknown Shader Type");
                return VK_SHADER_STAGE_VERTEX_BIT;
            }
        }

        VkPolygonMode VKUtilities::PolygonModeToVk(Excimer::Graphics::PolygonMode mode)
        {
            switch (mode)
            {
            ...
            case Graphics::PolygonMode::POINT:
                ...
                break;
            default:
                EXCIMER_LOG_CRITICAL("Unknown Polygon Mode");
                return VK_POLYGON_MODE_FILL;
                break;
            }
        }

        VkPrimitiveTopology VKUtilities::DrawTypeToVk(Excimer::Graphics::DrawType type)
        {
            switch (type)
            {
            ...
            case DrawType::POINT:
                ...
                break;
            default:
                EXCIMER_LOG_CRITICAL("Unknown Draw Type");
                return VK_PRIMITIVE_TOPOLOGY_TRIANGLE_LIST;
                break;
            }
        }
