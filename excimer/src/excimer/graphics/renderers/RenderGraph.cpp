...
#include "excimer/graphics/Renderers/IRenderer.h"
...
#include "excimer/graphics/MSDFData.h"

#include "excimer/events/ApplicationEvent.h"

#include "excimer/embedded/BRDFTexture.inl"
#include "excimer/embedded/CheckerBoardTextureArray.inl"

#include "excimer/platform/Vulkan/VKCommandBuffer.h"
#include "excimer/platform/Vulkan/VKTexture.h"
...
static const uint32_t RENDERER_POINT_SIZE = sizeof(Excimer::Graphics::PointVertexData) * 4;
...
static const uint32_t RENDERER_LINE_SIZE = sizeof(Excimer::Graphics::LineVertexData) * 4;
...
namespace Excimer::Graphics
{
    ...
    void RenderGraph::BeginScene(Scene* scene)
    {
        ...
        if (renderSettings.Renderer3DEnabled)
        {
            ...
            {
                EXCIMER_PROFILE_SCOPE("Get Light");
        ...
        if (renderSettings.Renderer2DEnabled)
        {
            ...
            {
                EXCIMER_PROFILE_SCOPE("Sort Meshes by distance from camera");
            ...
            {
                EXCIMER_PROFILE_SCOPE("Sort sprites by z value");
    ...
    {
        EXCIMER_PROFILE_FUNCTION();
        EXCIMER_PROFILE_GPU("Render Passes");
    ...
    void RenderGraph::UpdateCascades(Scene* scene, Light* light)
    {
        ...
        for (uint32_t i = 0; i < m_ShadowData.m_ShadowMapNum; i++)
        {
            EXCIMER_PROFILE_SCOPE("Create Cascade");
    ...
    {
        EXCIMER_PROFILE_FUNCTION();
        EXCIMER_PROFILE_GPU("Shadow Pass");
        ...
        for (uint32_t i = 0; i < m_ShadowData.m_ShadowMapNum; ++i)
        {
            EXCIMER_PROFILE_GPU("Shadow Layer Pass");
    ...
    {
        EXCIMER_PROFILE_FUNCTION();
        EXCIMER_PROFILE_GPU("Depth Pre Pass");
    ...
    {
        EXCIMER_PROFILE_FUNCTION();
        EXCIMER_PROFILE_GPU("Forward Pass");
    ...
    {
        EXCIMER_PROFILE_FUNCTION();
        EXCIMER_PROFILE_GPU("Tone Mapping Pass");
    ...
    {
        EXCIMER_PROFILE_FUNCTION();
        EXCIMER_PROFILE_GPU("Final Pass");
    ...
    {
        EXCIMER_PROFILE_FUNCTION();
        EXCIMER_PROFILE_GPU("Bloom Pass");
    ...
    {
        EXCIMER_PROFILE_FUNCTION();
        EXCIMER_PROFILE_GPU("Debanding Pass");
    ...
    {
        EXCIMER_PROFILE_FUNCTION();
        EXCIMER_PROFILE_GPU("Filmic Grain Pass");
    ...
    {
        EXCIMER_PROFILE_FUNCTION();
        EXCIMER_PROFILE_GPU("Outline Pass");
    ...
    {
        EXCIMER_PROFILE_FUNCTION();
        EXCIMER_PROFILE_GPU("ChromaticAberation Pass");
    ...
    {
        EXCIMER_PROFILE_FUNCTION();
        EXCIMER_PROFILE_GPU("Render2D Pass");
    ...
    void RenderGraph::TextPass()
    {
        ...
        for (auto entity : textGroup)
        {
            ...
            {
                EXCIMER_PROFILE_SCOPE("Convert to utf32string");
...

            {
                ...
                for (int i = 0; i < utf32string.size(); i++)
                {
                    ...
                    {
                        EXCIMER_PROFILE_SCOPE("Set text buffer data");
    ...
    {
        EXCIMER_PROFILE_FUNCTION();
        EXCIMER_PROFILE_GPU("Debug Pass");
