...
namespace Excimer
{
	...
	public:
		...
		Camera(float aspectRatio, float nearS, float farS);
		~Camera() = default;
		...
		Maths::Ray GetScreenRay(float x, float y, const glm::mat4& viewMartix, bool flipY) const;
