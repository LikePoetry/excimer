...
namespace Excimer
{
    namespace StringUtilities
    {
        ...
        std::vector<std::string> EXCIMER_EXPORT SplitString(const std::string& string, const std::string& delimiters);
        std::vector<std::string> EXCIMER_EXPORT SplitString(const std::string& string, const char delimiter);
        std::vector<std::string> EXCIMER_EXPORT Tokenize(const std::string& string);
