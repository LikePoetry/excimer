...
namespace Excimer
{
    ...
    {
        SetKeyPressed(Excimer::InputCode::Key(e.GetKeyCode()), e.GetRepeatCount() < 1);
        SetKeyHeld(Excimer::InputCode::Key(e.GetKeyCode()), true);
        return false;
    }

    bool Input::OnKeyReleased(KeyReleasedEvent& e)
    {
        SetKeyPressed(Excimer::InputCode::Key(e.GetKeyCode()), false);
        SetKeyHeld(Excimer::InputCode::Key(e.GetKeyCode()), false);
        return false;
    }

    bool Input::OnMousePressed(MouseButtonPressedEvent& e)
    {
        SetMouseClicked(Excimer::InputCode::MouseKey(e.GetMouseButton()), true);
        SetMouseHeld(Excimer::InputCode::MouseKey(e.GetMouseButton()), true);
        return false;
    }

    bool Input::OnMouseReleased(MouseButtonReleasedEvent& e)
    {
        SetMouseClicked(Excimer::InputCode::MouseKey(e.GetMouseButton()), false);
        SetMouseHeld(Excimer::InputCode::MouseKey(e.GetMouseButton()), false);
        return false;
    }
